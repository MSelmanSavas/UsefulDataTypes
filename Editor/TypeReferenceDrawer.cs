...
namespace GD.Utilities.Editor
{
    ...
    public class TypeReferenceDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            TypeReference typeReference = TypeHelper.GetTargetObjectOfProperty(property) as TypeReference;
            ...
            if (_foundTypes.Length <= 0)
            {
                ...
                if (TypeHelper.GetTargetObjectOfProperty(property).GetType().IsGenericType)
                {
                    object foundObj = TypeHelper.GetTargetObjectOfProperty(property);
